  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <article className="pt-32 pb-20 px-4 max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-black text-gray-900 mb-12 border-l-[12px] border-red-600 pl-8 uppercase tracking-tighter">
          The Voice of <span className="text-red-600">The People</span>
        </h1>
        <div className="prose prose-xl max-w-none text-gray-700 leading-relaxed font-medium space-y-8">
          ...
          <div className="bg-gray-50 p-10 rounded-[40px] border border-gray-100 my-12">
            <h2 className="text-2xl font-black text-gray-900 mb-4 uppercase tracking-tight">Our Core Values</h2>
