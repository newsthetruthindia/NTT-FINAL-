          ...
          <div className="max-w-4xl mx-auto px-4 mb-8">
            ...
            <div className="flex items-center justify-between py-8 border-y border-border mb-8">
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 rounded-full overflow-hidden bg-primary flex items-center justify-center text-white font-black text-xl shadow-2xl shadow-primary/20 ring-4 ring-background">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-start">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-foreground/70 text-lg leading-relaxed mb-8 italic">
                      {post.user.details?.bio || "A dedicated member of the NTT News Desk, committed to bringing you the unfiltered truth from the front lines."}
                    </p>
