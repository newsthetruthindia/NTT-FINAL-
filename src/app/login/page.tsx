...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-[100dvh] relative flex flex-col bg-[#0b1120] overflow-hidden dark">
      ...
      <div className="flex-grow pt-32 pb-8 flex flex-col items-center justify-center px-4 relative z-10 overflow-y-auto">
              ...
              <form className="space-y-3" onSubmit={handleSubmit}>
                ...
                <div className="space-y-1">
                  ...
                  <input 
                    ...
                    required
                    className="w-full px-5 py-2 bg-white/5 border border-white/10 focus:border-primary/50 rounded-xl outline-none transition-all duration-300 font-sans text-white text-sm placeholder:text-white/10 focus:ring-2 focus:ring-primary/5" 
