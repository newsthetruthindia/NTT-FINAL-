        ...
        >
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-[10px] text-foreground/40 font-bold uppercase tracking-widest leading-none">Instant Story Synthesis</p>
            </div>
          </div>
          <div className={`w-10 h-10 rounded-full bg-foreground/5 flex items-center justify-center transform transition-all duration-500 group-hover:bg-primary/10 ${isOpen ? 'rotate-180 bg-primary/10 text-primary' : 'text-foreground/40'}`}>
        ...
        {isOpen && (
          <div className="px-8 pb-10 animate-in fade-in slide-in-from-top-4 duration-700">
            ...
            <div className="mt-12 p-6 rounded-3xl bg-primary/5 border border-primary/10 flex items-center gap-4">
              ...
              <p className="text-[10px] text-primary/60 font-black uppercase tracking-[0.15em] leading-relaxed">
                Summary generated by NTT Intelligence. Please review original content for full context.
              </p>
            </div>
          </div>
        )}
