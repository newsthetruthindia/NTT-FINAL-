...
export default function ReportForm() {
  ...
  if (status === 'success') {
    return (
      <div className="bg-card rounded-[48px] p-12 text-center shadow-2xl border border-border animate-in zoom-in duration-500">
        ...
        <h2 className="text-4xl font-black text-foreground mb-4 tracking-tighter">Report Received</h2>
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-card rounded-[48px] p-8 md:p-16 shadow-2xl border border-border">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div className="space-y-2">
          ...
          <input 
            ...
            className="w-full bg-card/50 border-2 border-border focus:border-primary/20 focus:bg-card rounded-3xl px-8 py-5 text-foreground placeholder-gray-400 transition-all outline-none"
            value={formData.name}
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          ...
          <textarea 
            ...
            className="w-full bg-card/50 border-2 border-border focus:border-primary/20 focus:bg-card rounded-[32px] px-8 py-5 text-foreground placeholder-gray-400 transition-all outline-none resize-none"
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            />
            <div className="w-full bg-background border-2 border-dashed border-border group-hover:border-primary/50 group-hover:bg-card/50 rounded-[32px] px-8 py-10 transition-all flex flex-col items-center justify-center text-center">
              <div className="w-12 h-12 bg-primary/5 rounded-full flex items-center justify-center mb-4 text-gray-400 group-hover:text-primary transition-colors">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
              </div>
              <p className="text-foreground font-bold text-sm mb-1">{file ? file.name : 'Click or Drag files to upload'}</p>
