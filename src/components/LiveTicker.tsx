...
export default function LiveTicker() {
  ...
  return (
    <div className="bg-gray-950 text-white h-10 flex items-center overflow-hidden border-b border-white/5 relative z-[60]">
      <div className="bg-primary flex items-center px-4 h-full shrink-0 relative">
        <span className="text-[10px] font-black uppercase tracking-[0.2em] relative z-10 flex items-center gap-2">
      ...
      <div className="flex-grow relative h-full flex items-center px-6 overflow-hidden">
        ...
        >
          <p className="text-[12px] font-bold tracking-wide truncate max-w-[80vw]">
            {headlines[currentIndex]}
          </p>
          <Link 
            href="/" 
            className="shrink-0 text-[10px] font-black uppercase tracking-widest text-primary hover:text-white transition-colors border-b border-primary/20 hover:border-white/50 pb-0.5"
          >
            Details →
          </Link>
        </div>
      ...
      <div className="hidden md:flex items-center gap-4 px-6 h-full shrink-0 border-l border-white/10 italic text-gray-500 text-[10px] font-bold tracking-widest uppercase">
