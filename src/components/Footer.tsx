        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-4">
              {[
                { name: 'X', url: 'https://x.com/newsthetruthin', path: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z' },
                { name: 'Facebook', url: 'https://www.facebook.com/newsthetruthindia', path: 'M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z' },
                { name: 'Instagram', url: 'https://www.instagram.com/newsthetruthindia', path: 'M12.315 2c2.432 0 2.719.012 3.881.064 1.157.052 1.947.235 2.639.504.717.279 1.323.651 1.928 1.256.606.606.977 1.212 1.256 1.928.269.692.452 1.482.504 2.639.052 1.162.064 1.549.064 4.316 0 2.767-.012 3.154-.064 4.316-.052 1.157-.235 1.947-.504 2.639-.279.717-.651 1.323-1.256 1.928-.606.606-1.212.977-1.928 1.256-.692.269-1.482.452-2.639.504-1.162.052-1.549.064-4.316.064-2.767 0-3.154-.012-4.316-.064-1.157-.052-1.947-.235-2.639-.504-.717-.279-1.323-.651-1.928-1.256-.606-.606-.977-1.212-1.256-1.928-.269-.692-.452-1.482-.504-2.639C2.012 15.154 2 14.767 2 12s.012-3.154.064-4.316c.052-1.157.235-1.947.504-2.639.279-.717.651-1.323 1.256-1.928.606-.606 1.212-.977 1.928-1.256.692-.269 1.482-.452 2.639-.504C9.154 2.012 9.541 2 12.315 2zM12 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z' }
              ].map((social) => (
                <a key={social.name} href={social.url} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white/5 rounded-xl text-gray-400 hover:text-primary hover:bg-white/10 transition-all duration-300" aria-label={social.name}>
