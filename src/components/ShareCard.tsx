...
export default function ShareCard({ title, quote }: ShareCardProps) {
  ...
  return (
    <div className="mt-16 p-10 bg-gray-950 rounded-[48px] overflow-hidden relative group border border-white/5">
      {/* Background Accent */}
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button className="flex items-center gap-3 px-8 py-4 bg-white/5 border border-white/10 rounded-full text-white text-[11px] font-black uppercase tracking-widest hover:bg-white/10 transition-all duration-300">
            Share to WhatsApp
